...
import { useViewedPosts } from '@/hook/useViewedPosts';
...
function EmptyHistory() {
    return (
        <div className="flex flex-col items-center justify-center px-6 py-24 text-center">
            ...
            <h2 className="text-lg font-semibold">No viewed posts yet</h2>
            <p className="mt-1.5 max-w-xs text-sm text-muted-foreground">
                Posts you spend time with in the feed will show up here.
            </p>
            <Link
                href="/"
